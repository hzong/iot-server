 ...
 * @Created by hzong
 */
public class CMDFunA1Service implements ICMDService<IOTPacket> {

    /**
     * logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(CMDFunA1Service.class);

    public EFunCode code() {
        return EFunCode.FN_A1;
    }
