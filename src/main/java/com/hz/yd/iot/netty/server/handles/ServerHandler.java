package com.hz.yd.iot.netty.server.handles;
...
public class ServerHandler extends SimpleChannelInboundHandler<IOTPacket> {
    /**
     * logger
     */
    ...
    protected void channelRead0(ChannelHandlerContext channelHandlerContext, IOTPacket packet) throws Exception {
        ...
        //功能调用逻辑
        manager.handle( ProtocolTool.funCode(packet.getBody()),packet);
